...
namespace ClassicAssist.Data
{
    public class Options : SetPropertyNotifyChanged
    {
        ...
        private int _hueNotorietyAlly = 34;
        private int _hueNotorietyAttackable = 34;
        private int _hueNotorietyCriminal = 34;
        private int _hueNotorietyEnemy = 34;
        private int _hueNotorietyInnocent = 34;
        private int _hueNotorietyInvulnerable = 34;
        private int _hueNotorietyMurderer = 34;
        ...
        public int HueNotorietyAlly
        {
            get => _hueNotorietyAlly;
            set => SetProperty( ref _hueNotorietyAlly, value );
        }

        public int HueNotorietyAttackable
        {
            get => _hueNotorietyAttackable;
            set => SetProperty( ref _hueNotorietyAttackable, value );
        }

        public int HueNotorietyCriminal
        {
            get => _hueNotorietyCriminal;
            set => SetProperty( ref _hueNotorietyCriminal, value );
        }

        public int HueNotorietyEnemy
        {
            get => _hueNotorietyEnemy;
            set => SetProperty( ref _hueNotorietyEnemy, value );
        }

        public int HueNotorietyInnocent
        {
            get => _hueNotorietyInnocent;
            set => SetProperty( ref _hueNotorietyInnocent, value );
        }

        public int HueNotorietyInvulnerable
        {
            get => _hueNotorietyInvulnerable;
            set => SetProperty( ref _hueNotorietyInvulnerable, value );
        }

        public int HueNotorietyMurderer
        {
            get => _hueNotorietyMurderer;
            set => SetProperty( ref _hueNotorietyMurderer, value );
        }
        ...
        public int GetNotorietyHue( Notoriety notoriety )
        {
            switch ( notoriety )
            {
                case Notoriety.Innocent:
                    return HueNotorietyInnocent;
                case Notoriety.Ally:
                    return HueNotorietyAlly;
                case Notoriety.Attackable:
                    return HueNotorietyAttackable;
                case Notoriety.Criminal:
                    return HueNotorietyCriminal;
                case Notoriety.Enemy:
                    return HueNotorietyEnemy;
                case Notoriety.Murderer:
                    return HueNotorietyMurderer;
                case Notoriety.Invulnerable:
                    return HueNotorietyInvulnerable;
                default:
                    return 34;
            }
        }
